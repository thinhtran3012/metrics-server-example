...
static ngx_command_t ngx_http_vhost_traffic_status_commands[] = {
    ...
    { ngx_string("vhost_traffic_status_metrics_size"),
      NGX_HTTP_MAIN_CONF|NGX_HTTP_SRV_CONF|NGX_HTTP_LOC_CONF|NGX_CONF_TAKE1,
      ngx_conf_set_size_slot,
      NGX_HTTP_LOC_CONF_OFFSET,
      offsetof(ngx_http_vhost_traffic_status_loc_conf_t, metrics_size),
      NULL },

    { ngx_string("vhost_traffic_status_rtmp_stats"),
      NGX_HTTP_MAIN_CONF|NGX_HTTP_SRV_CONF|NGX_HTTP_LOC_CONF|NGX_CONF_FLAG,
      ngx_conf_set_flag_slot,
      NGX_HTTP_LOC_CONF_OFFSET,
      offsetof(ngx_http_vhost_traffic_status_loc_conf_t, rtmp_stats),
      NULL },

    { ngx_string("vhost_traffic_status_rtmp_stats_url"),
      NGX_HTTP_MAIN_CONF|NGX_HTTP_SRV_CONF|NGX_HTTP_LOC_CONF|NGX_HTTP_LMT_CONF|NGX_CONF_TAKE1,
      ngx_conf_set_str_slot,
      NGX_HTTP_LOC_CONF_OFFSET,
      offsetof(ngx_http_vhost_traffic_status_loc_conf_t, rtmp_stats_url),
      NULL },

    { ngx_string("vhost_traffic_status_net_stats"),
      NGX_HTTP_MAIN_CONF|NGX_HTTP_SRV_CONF|NGX_HTTP_LOC_CONF|NGX_CONF_FLAG,
      ngx_conf_set_flag_slot,
      NGX_HTTP_LOC_CONF_OFFSET,
      offsetof(ngx_http_vhost_traffic_status_loc_conf_t, net_stats),
      NULL },

    { ngx_string("vhost_traffic_status_disk_stats"),
      NGX_HTTP_MAIN_CONF|NGX_HTTP_SRV_CONF|NGX_HTTP_LOC_CONF|NGX_CONF_FLAG,
      ngx_conf_set_flag_slot,
      NGX_HTTP_LOC_CONF_OFFSET,
      offsetof(ngx_http_vhost_traffic_status_loc_conf_t, disk_stats),
      NULL },

    { ngx_string("vhost_traffic_status_cpu_stats"),
      NGX_HTTP_MAIN_CONF|NGX_HTTP_SRV_CONF|NGX_HTTP_LOC_CONF|NGX_CONF_FLAG,
      ngx_conf_set_flag_slot,
      NGX_HTTP_LOC_CONF_OFFSET,
      offsetof(ngx_http_vhost_traffic_status_loc_conf_t, cpu_stats),
      NULL },
    { ngx_string("vhost_traffic_status_disk_utilization"),
      NGX_HTTP_MAIN_CONF|NGX_HTTP_SRV_CONF|NGX_HTTP_LOC_CONF|NGX_CONF_FLAG,
      ngx_conf_set_flag_slot,
      NGX_HTTP_LOC_CONF_OFFSET,
      offsetof(ngx_http_vhost_traffic_status_loc_conf_t, disk_utilization),
      NULL },

    { ngx_string("vhost_traffic_status_load_avg"),
      NGX_HTTP_MAIN_CONF|NGX_HTTP_SRV_CONF|NGX_HTTP_LOC_CONF|NGX_CONF_FLAG,
      ngx_conf_set_flag_slot,
      NGX_HTTP_LOC_CONF_OFFSET,
      offsetof(ngx_http_vhost_traffic_status_loc_conf_t, load_avg),
      NULL },

    { ngx_string("vhost_traffic_status_mem_info"),
      NGX_HTTP_MAIN_CONF|NGX_HTTP_SRV_CONF|NGX_HTTP_LOC_CONF|NGX_CONF_FLAG,
      ngx_conf_set_flag_slot,
      NGX_HTTP_LOC_CONF_OFFSET,
      offsetof(ngx_http_vhost_traffic_status_loc_conf_t, mem_info),
      NULL },

    { ngx_string("vhost_traffic_status_netdev_stats"),
      NGX_HTTP_MAIN_CONF|NGX_HTTP_SRV_CONF|NGX_HTTP_LOC_CONF|NGX_CONF_FLAG,
      ngx_conf_set_flag_slot,
      NGX_HTTP_LOC_CONF_OFFSET,
      offsetof(ngx_http_vhost_traffic_status_loc_conf_t, netdev_stats),
      NULL },
    
    { ngx_string("vhost_traffic_status_uname_info"),
      NGX_HTTP_MAIN_CONF|NGX_HTTP_SRV_CONF|NGX_HTTP_LOC_CONF|NGX_CONF_FLAG,
      ngx_conf_set_flag_slot,
      NGX_HTTP_LOC_CONF_OFFSET,
      offsetof(ngx_http_vhost_traffic_status_loc_conf_t, uname_info),
      NULL },

    { ngx_string("vhost_traffic_status_vm_stats"),
      NGX_HTTP_MAIN_CONF|NGX_HTTP_SRV_CONF|NGX_HTTP_LOC_CONF|NGX_CONF_FLAG,
      ngx_conf_set_flag_slot,
      NGX_HTTP_LOC_CONF_OFFSET,
      offsetof(ngx_http_vhost_traffic_status_loc_conf_t, vm_stats),
      NULL },
    { ngx_string("vhost_traffic_status_live_session_stats"),
      NGX_HTTP_MAIN_CONF|NGX_HTTP_SRV_CONF|NGX_HTTP_LOC_CONF|NGX_CONF_FLAG,
      ngx_conf_set_flag_slot,
      NGX_HTTP_LOC_CONF_OFFSET,
      offsetof(ngx_http_vhost_traffic_status_loc_conf_t, live_session_stats),
      NULL },
...
ngx_http_vhost_traffic_status_create_loc_conf(ngx_conf_t *cf)
{
    ...
    conf->metrics_size = NGX_CONF_UNSET_SIZE;
    conf->rtmp_stats = NGX_CONF_UNSET;
    conf->net_stats = NGX_CONF_UNSET;
    conf->disk_stats = NGX_CONF_UNSET;
    conf->cpu_stats = NGX_CONF_UNSET;
    conf->disk_utilization = NGX_CONF_UNSET;
    conf->load_avg = NGX_CONF_UNSET;
    conf->mem_info = NGX_CONF_UNSET;
    conf->netdev_stats = NGX_CONF_UNSET;
    conf->uname_info = NGX_CONF_UNSET;
    conf->vm_stats = NGX_CONF_UNSET;
    conf->live_session_stats = NGX_CONF_UNSET;
    return conf;
}
...
ngx_http_vhost_traffic_status_merge_loc_conf(ngx_conf_t *cf, void *parent, void *child)
{
    ...
    ngx_conf_merge_str_value(conf->rtmp_stats_url, prev->rtmp_stats_url,
                             NGX_RTMP_DEFAULT_URL);
                             
    ngx_conf_merge_value(conf->bypass_limit, prev->bypass_limit, 0);
    ngx_conf_merge_value(conf->bypass_stats, prev->bypass_stats, 0);
    ngx_conf_merge_size_value(conf->metrics_size, prev->metrics_size, METRIC_DEFAULT_SIZE);
    ngx_conf_merge_value(conf->rtmp_stats, prev->rtmp_stats, 0);
    ngx_conf_merge_value(conf->net_stats, prev->net_stats, 0);
    ngx_conf_merge_value(conf->disk_stats, prev->disk_stats, 0);
    ngx_conf_merge_value(conf->cpu_stats, prev->cpu_stats, 0);
    ngx_conf_merge_value(conf->disk_utilization, prev->disk_utilization, 0);
    ngx_conf_merge_value(conf->load_avg, prev->load_avg, 0);
    ngx_conf_merge_value(conf->mem_info, prev->mem_info, 0);
    ngx_conf_merge_value(conf->netdev_stats, prev->netdev_stats, 0);
    ngx_conf_merge_value(conf->uname_info, prev->uname_info, 0);
    ngx_conf_merge_value(conf->vm_stats, prev->vm_stats, 0);
    ngx_conf_merge_value(conf->live_session_stats, prev->live_session_stats, 0);
