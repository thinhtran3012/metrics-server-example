...
#define NGX_RTMP_DEFAULT_URL "http://127.0.0.1:8181/stats"

#define CACHE_STATS 0
#define ADD_SUM_ALL 0
...
typedef struct {
    ...
    size_t                                  metrics_size;
    ngx_flag_t                              rtmp_stats;
    ngx_str_t                               rtmp_stats_url;
    ngx_flag_t                              net_stats;
    ngx_flag_t                              disk_stats;
    ngx_flag_t                              cpu_stats;
    ngx_flag_t                              disk_utilization;
    ngx_flag_t                              load_avg;
    ngx_flag_t                              mem_info;
    ngx_flag_t                              netdev_stats;
    ngx_flag_t                              uname_info;
    ngx_flag_t                              vm_stats;
    ngx_flag_t                              live_session_stats;
